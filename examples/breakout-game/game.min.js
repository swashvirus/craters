! function(t) {
    ...
    "use strict";
    s.r(e), s.d(e, "Vector", function() {
        return c
    }), s.d(e, "boundary", function() {
        return o
    }), s.d(e, "degToRad", function() {
        return i
    }), s.d(e, "radToDeg", function() {
        return n
    }), s.d(e, "distance", function() {
        return a
    }), s.d(e, "map", function() {
        return r
    });
    ...
    c.prototype = {
        ...
        add: function() {
            ...
            } else 2 === s.length && "number" == typeof s[0] && "number" == typeof s[1] && (t = s[0], e = s[1]);
    ...
    class n {
        constructor() {
            this.entities = [], this.state = {
                size: new i.Vector(1024, 512),
                gravity: new i.Vector(0, 0),
                friction: new i.Vector(0, 0)
            }
        }
        addObject(t) {
        ...
        update(t, e) {
            this.entities.forEach(t => {
                switch (t.state.loop = this.state.loop, t.update(), t.type) {
                    case "dynamic":
                        t.state.vel.x += t.state.accel.x + (t.state.gravity.x + this.state.gravity.x), t.state.vel.y += t.state.accel.y + (t.state.gravity.y + this.state.gravity.y), t.state.pos.x += t.state.vel.x * (1 / ((t.state.loop.delta + t.state.loop.nframe) / 2)), t.state.pos.y += t.state.vel.y * (1 / ((t.state.loop.delta + t.state.loop.nframe) / 2));
                        var e = t.state.friction.x,
                            ...
                            a = t.state.vel.y + n,
                            r = t.state.vel.y - n;
                        t.state.vel.x = s < 0 ? s : i > 0 ? i : 0, t.state.vel.y = a < 0 ? a : r > 0 ? r : 0;
                        break;
                    case "static":
    ...
    class a extends n {
        constructor() {
            super(), this.state.size = new i.Vector(20, 20), this.state.pos = new i.Vector(0, 0), this.state.vel = new i.Vector(0, 0), this.state.accel = new i.Vector(0, 0), this.state.radius = 20, this.state.angle = 0, this.type = "dynamic"
        }
    }
    class r extends a {
        constructor(t, e) {
            super(), this.scope = t, this.state.pos = e.pos || new i.Vector(0, 0), this.state.crop = new i.Vector(0, 0), this.state.size = e.size || new i.Vector(0, 0), this.state.frames = e.frames || [], this.state.angle = e.angle || 0, this.state.image = e.image || new Image, this.state.delay = e.delay || 5, this.state.tick = e.tick || 0, this.state.orientation = e.orientation || "horizontal"
        }
        update() {
    ...
    class i {
        constructor(t, e) {
            var s = {
                ...
                main: function() {
                    s.startLoop = window.requestAnimationFrame(s.main), s.delta = Math.round(1e3 / (window.performance.now() - s.before) * 100 / 100), window.performance.now() < s.before + s.tframe || (s.before = window.performance.now(), s.stopLoop = () => {
                        window.cancelAnimationFrame(s.startLoop)
                    }, t.state.loop = s, t.update(s.elapsed, s.delta), t.render(s.elapsed, s.delta), s.elapsed++)
                }
            };
            return s.main(), s
        }
    ...
    class n {
        constructor(t, e, s) {
            ...
            var i = document.createElement("canvas"),
                n = i.getContext("2d"),
                a = window.devicePixelRatio / ["webkitBackingStorePixelRatio", "mozBackingStorePixelRatio", "msBackingStorePixelRatio", "oBackingStorePixelRatio", "backingStorePixelRatio"].reduce(function(t, e) {
                    return Object.prototype.hasOwnProperty.call(n, e) ? n[e] : 1
                });
            return i.width = Math.round(t * a), i.height = Math.round(e * a), i.style.width = t + "px", i.style.height = e + "px", n.setTransform(a, 0, 0, a, 0, 0), s.insertBefore(i, s.firstChild), i.context = i.getContext("2d"), i.resize = (t, e) => {
                i.style.width = e.x + "px", i.style.height = e.y + "px", i.width = Math.round(e.x * a), i.height = Math.round(e.y * a), n.setTransform(a, 0, 0, a, 0, 0), t.state.size.x = e.x, t.state.size.y = e.y
            }, i.clear = (t, e, s, n, a) => {
                t = t || null, e = e || 0, s = s || 0, n = n || i.width, a = a || i.height, t ? (i.context.save(), i.context.fillStyle = t, i.context.fillRect(e, s, n, a), i.context.fill(), i.context.restore()) : i.context.clearRect(e, s, n, a)
            }, i.camera = (t, e) => {
    ...
    class i {
        ...
        unlock(t, e, s, i) {
            var n = this,
                a = ["touchstart", "touchend", "mousedown", "keydown"],
                r = function r() {
        ...
        play(t, e, s, i) {
            ...
            return n.volume = "number" == typeof s ? s : this.defaultVolume, n.loop = i, n.play(), this.instances.push(n), n.addEventListener("ended", () => {
                var t = this.instances.indexOf(n); - 1 !== t && this.instances.splice(t, 1)
            }), "function" == typeof e ? (n.addEventListener("ended", e), !0) : new Promise((t, e) => n.addEventListener("ended", t))
        }
        stopAll() {
    ...
    class r extends i.Game {
        constructor(t, e, s) {
            super(), this.state.size = {
                ...
                x: 0,
                y: 0
            }, this.viewport = new i.Canvas(this.state.size.x, this.state.size.y, t), this.context = this.viewport.context, this.context.fillStyle = "#fff", this.loop = new i.Loop(this, 60), this.ball = this.entities.push(new o(this)) - 1, this.paddle = this.entities.push(new h(this)) - 1, this.bamboos = this.started = this.score = 0, window.addEventListener("resize", () => {
        ...
        render() {
            this.viewport.clear(), document.addEventListener("click", () => {
                this.started++
            }), this.started < 1 ? this.context.drawImage(n.fetch("./media/TapToPlay@3x.png"), (this.state.size.x - 300) / 2, (this.state.size.y - 180) / 2, 300, 180) : (this.context.font = "2em Arial", this.context.fillText("SCORE: ️" + this.score, 16, 50, this.state.size.x), super.render())
        }
        newgame(t, e) {
            for (var s = 0; s < t; s++)
                for (var i = 0; i < e; i++) {
                    var n = this.entities.push(new c(this, {
                        x: 138 * i,
                        y: 53 * s
                    })) - 1;
                    this.entities[n].id = n, this.bamboos++
                }
        }
    }
    class o extends i.Sprite {
        constructor(t) {
            super(t, {
                frames: [0],
                image: n.fetch("./media/ball@3x.png")
        ...
        update() {
            if (super.update(), this.state.pos.x + this.state.size.x > this.scope.state.size.x) {
            ...
            if (l.detect(this.scope.entities[this.scope.paddle], this)) {
                if (this.state.vel.y < 0) return;
                this.state.vel.y *= -1
            }
        }
    ...
    class c extends i.Sprite {
        constructor(t, e) {
            super(t, {
                frames: [0],
                image: n.fetch("./media/block@3x.png")
            ...
            for (var s = 0; s < 10; s++) this.entities.push(new u(this.scope, {
                x: this.state.pos.x,
                y: this.state.pos.y
            }))
        }
        update() {
            if (super.update(), l.detect(this.scope.entities[this.scope.ball], this)) {
                this.scope.score += 10, this.scope.bamboos--, a.play("pop");
                var t = this.id;
    ...
    class u extends i.Sprite {
        constructor(t, e) {
            super(t, {
                frames: [0]
            }), this.scope = t, this.state.image = n.fetch("./media/block_break01@3x.png"), this.state.size = {
                x: 45,
                y: 35
            }, this.state.pos = e, this.state.vel.y = 150 * (Math.random() - .5), this.state.vel.x = 150 * (Math.random() - .5), this.state.gravity.y = .25, this.state.friction = {
                x: .005,
                y: .005
            }
        }
        update() {
            if (super.update(), this.state.pos.y + this.state.size.y > this.scope.state.size.y) {
                if (this.state.vel.y < 0) return;
                this.state.vel.y *= -1
            }
        }
    }
    class h extends i.Sprite {
        constructor(t) {
            super(t, {
                frames: [0],
                image: n.fetch("./media/paddle@3x.png")
            }), this.scope = t, this.state.size = {
                x: 180,
                y: 69
            }
    ...
    class l {
        static detect(t, e) {
            var s = t.state.pos.x,
                ...
                c = r + e.state.size.x,
                u = o + e.state.size.y;
            return !(a < o || i > u || n < r || s > c)
        }
        static solve(t, e) {
            var s = .5 * t.state.size.x + t.state.pos.x,
                i = .5 * t.state.size.y + t.state.pos.y,
                n = .5 * e.state.size.x + e.state.pos.x,
                a = .5 * e.state.size.y + e.state.pos.y,
                r = (n - s) / e.state.size.y * .5,
                o = (a - i) / e.state.size.y * .5,
                c = abs(r),
                u = abs(o);
    ...
    a.load("pop", "./media/music/pop.ogg", function() {
        n.load(["./media/ball@3x.png", "./media/paddle@3x.png", "./media/block@3x.png", "./media/block_break01@3x.png", "./media/TapToPlay@3x.png"], function() {
            window.game = new r("#container", window.innerWidth, window.innerHeight, 60, !0)
        })
    })
}, function(t, e, s) {
    t.exports = s(9)
    ...
    s.r(e),
        function(t, i) {
            s.d(e, "Craters", function() {
                return u
            });
            var n = s(0);
            s.d(e, "Maths", function() {
                return n
            });
            var a = s(4);
            s.d(e, "Canvas", function() {
                return a.a
            }), s.d(e, "Loop", function() {
                return a.b
            });
            ...
            s.d(e, "Game", function() {
                return r.b
            }), s.d(e, "Entity", function() {
                return r.a
            }), s.d(e, "Sprite", function() {
                return r.c
            });
            var o = s(5);
            s.d(e, "Loader", function() {
                return o.a
            });
            var c = s(6);
            s.d(e, "Sound", function() {
                return c.a
        ...
        }.call(this, s(3), s(10).setImmediate)
}, function(t, e, s) {
    (function(t) {
        ...
        }, s(11), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, s(3))
}, function(t, e, s) {
    (function(t, e) {
        ! function(t, s) {
                ...
                d = d && d.setTimeout ? d : t, "[object process]" === {}.toString.call(t.process) ? i = function(t) {
                    ...
                    if (t.postMessage && !t.importScripts) {
                        ...
                        return t.onmessage = function() {
                            e = !1
                        }, t.postMessage("", "*"), t.onmessage = s, e
                    }
                }() ? t.MessageChannel ? ((a = new MessageChannel).port1.onmessage = function(t) {
                    p(t.data)
                }, i = function(t) {
                    a.port2.postMessage(t)
                }) : l && "onreadystatechange" in l.createElement("script") ? (n = l.documentElement, i = function(t) {
                    ...
                    setTimeout(p, 0, t)
                } : (r = "setImmediate$" + Math.random() + "$", o = function(e) {
                    ...
                    for (var e = new Array(arguments.length - 1), s = 0; s < e.length; s++) e[s] = arguments[s + 1];
                    var n = {
                        callback: t,
                        args: e
                    };
    ...
    function d() {
        h && c && (h = !1, c.length ? u = c.concat(u) : l = -1, u.length && f())
    }
    ...
    n.nextTick = function(t) {
        ...
        u.push(new p(t, e)), 1 !== u.length || h || o(f)
