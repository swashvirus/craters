! function(t) {
    ...
    class i {
        constructor(t, e) {
            var s = {
                ...
                main: function() {
                    s.startLoop = window.requestAnimationFrame(s.main), s.fps = Math.round(1e3 / (window.performance.now() - s.before) * 100 / 100), window.performance.now() < s.before + s.tframe || (s.before = window.performance.now(), s.stopLoop = () => {
                        window.cancelAnimationFrame(s.startLoop)
                    }, t.update(s.elapsed, s.fps), t.render(s.elapsed, s.fps), s.elapsed++)
                }
            };
            return s.main(), s
        }
    ...
    class n {
        constructor(t, e, s) {
            ...
            return i.width = Math.round(t * a), i.height = Math.round(e * a), i.style.width = t + "px", i.style.height = e + "px", n.setTransform(a, 0, 0, a, 0, 0), s.insertBefore(i, s.firstChild), i.context = i.getContext("2d"), i.resize = (t, e) => {
                ...
                t = t || 0, e = e || 0, s = s || i.width, n = n || i.height, i.context.clearRect(t, e, s, n)
            }, i.camera = (t, e) => {
    ...
    class u extends i.Sprite {
        constructor(t, e) {
            super(t, {
                ...
                x: 45,
                y: 35
            }, this.state.pos = e, this.state.vel.y = 15 * (Math.random() - .5), this.state.vel.x = 15 * (Math.random() - .5), this.state.gravity.y = .15, this.state.friction = {
                x: .005,
                y: .005
            }
        }
        update() {
            ...
            this.state.pos.y = i.Maths.boundary(this.state.pos.y, this.state.size.y, this.scope.state.size.y - this.state.size.y)
        }
    }
    ...
    n.prototype = {
        ...
        getAngle: function(t) {
            if ("DEGREES" === t) return Object(i.radToDeg)(Math.atan(this.y / this.x));
    ...
    }, n.prototype.translate = n.prototype.add;
    n.add = function(t, e) {
        return new n(t.x + e.x, t.y + e.y)
    }, n.subtract = function(t, e) {
        return new n(t.x - e.x, t.y - e.y)
    }, n.multiply = function(t, e) {
        return "number" == typeof t && "number" == typeof e ? t * e : "object" == typeof t && "number" == typeof e ? new n(t.x * e, t.y * e) : "object" == typeof e && "number" == typeof t ? new n(t * e.x, t * e.y) : new n(t.x * e.x, t.y * e.y)
    }, n.dot = function(t, e) {
